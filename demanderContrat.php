...
<head>
  <title>Demander nouveau contrat</title>
  <meta charset="utf-8">
...
<section class="container" style="width: 60%">
    <div class="brand-name">
        ...
        <h1>Demander un nouveau contrat</h1>
...
<div class="insc-form">
        <form role="form" method="post">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      <label for="nom_veh">Nom véhicule</label>
                        <input type="text" class="form-control" id="nom_veh" name="nom_veh" required>
                    </div>
            ...
            <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="num_chass" name="num_chass" required>
            </div>
            <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                          ...
                          <input type="number" class="form-control" id="valeur_veh" name="valeur_veh" required>
                    </div>
                </div>
            </div>
            ...
            <fieldset style="margin-top: 50px">
                ...
                <div class="form-group  form-inline text-center">
                    <div class="checkbox">
                          <label><input type="checkbox" value="" class="dasc" name="dasc"> Dommages avec ou sans collisions (Tous risques) </label>
                    </div>
                    <div class="checkbox">
                ...
                <div class="form-group text-center">
                    ...
                    <div class="checkbox" style="margin-top: 30px">
                          <label><input type="checkbox" value="" id="dc" name="dc"> Dommages collision </label>
                    </div>
                </div>
                ...
                <p class="text-center" style="margin-top: 30px; font-size: 18px">Voir <a href="#" data-toggle="modal" 
                 data-target="#compteModal">détails </a> sur calcul devis.</p>
                
                <div class="aff-devis">
                    <p class="lead" style="color: #E41B17; margin-top: 60px;margin-left: 310px; font-weight: bold" 
                       id="affichageDevis"></p>
                </div>
                
                <button style="width: 49%; float: right" type="button" class="btn btn-primary btn-lg btn-block" 
                        name="demander" id="demander">Créer un compte</button>
                
                <a href="php/annulerSessionDemande.php"><button style="width: 49%; float: left; margin-top:40px" type="button" class="btn annuler btn-lg btn-block">Annuler</button></a>
            
            </fieldset>
        </form>
    
        <p class="lead" style="margin-top: 30px">Un clic sur <span style="font-weight: bold">Créer un compte</span> signifie que vous acceptez les <a href="#">Conditions d’utilisation</a> et la <a href="#">Déclaration sur la confidentialité et les cookies</a>.
        </p>
...
<section class="footer">
    ...
    <script type="text/javascript" src="js/verifFormDemandeContrat.js"></script>
...
$("#demander").click(function(){
    ...
    var dure = $("#dure").val();
        ...
        if(immatVerif==1 && puissanceVerif==1 && num_chassVerif==1 && nom_vehVerif==1 && marqueVerif==1){
            ...
            /*Start calculer le devis avant accepte la demande */

                    $.ajax({

                           type:"post",
                           url:"contrat/demandercontratvisiteur.php",
                           data:
                               {
                                'marque':marque,
                                'nom_veh':nom_veh,
                           ...
                           success:function(reponse){
                              //  alert(reponse);
                                if(reponse=="exist"){
                                    ...
                                    Lobibox.alert('error', {
                                    msg: "Verifer le numero de permit et le numero de chassis de votre vehicule"
                                    });
                                     ...
                                     // window.location.replace("client.php");
                                          window.setTimeout(function(){
                                                 ...
                                                 window.location.href = "clientbloque.php";
