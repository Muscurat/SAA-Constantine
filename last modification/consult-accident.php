...
include ('connexion.php');
        ...
        $reponse = $bdd->query('SELECT vehicule.id_vehicule, vehicule.imat, vehicule.nom, vehicule.marque, accident.date_accid, accident.imat_b, accident.devis_rem, accident.source, accident.dest, accident.nom_cond, accident.prenom_cond, accident.lieu, accident.id_accident, user.nom, user.prenom
        FROM user
        ...
        WHERE accident.devis_rem IS NOT NULL'); 
?>
    ...
    <div class="modal-content">
      <div class="modal-header" style="background-color: #CCC">
        ...
        <div class="modal-body" style="font-weight: bold">
            ...
            <h2>Devis de remboursement: <span id="devis_rem_det"></span> dz</h2>
