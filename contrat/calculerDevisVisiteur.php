...
function calZone () {
    ...
    $devis = calculerRc ($usage,$puissance,$conn) + calculerDasc ($valeur_veh,$usage,$genre,$genre_2,
     $genre_3,$conn) + calculerViv ($valeur_veh,$conn) + calculerDc ($usage,$puissance,$conn) + calZone ();
