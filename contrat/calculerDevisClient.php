...
//    echo $gar_rc;
//    
function calculerDasc ($valeur_veh,$usage,$genre,$genre_2,$genre_3,$conn) {
    ...
    if ( !empty($_POST['dasc']) ) {
        ...
        switch($usage) {
            ...
            case "utilitaire": switch($genre_2){
...
function calZone () {
    ...
    $devis = calculerRc ($usage,$puissance,$conn) + calculerDasc ($valeur_veh,$usage,$genre,$genre_2,$genre_3,$conn) + calculerViv ($valeur_veh,$conn) + calculerDc ($usage,$puissance,$conn) + calZone ();
