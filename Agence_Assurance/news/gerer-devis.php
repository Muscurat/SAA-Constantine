...
include ('connexion.php');
        ...
        $reponse = $conn->query('SELECT vehicule.imat, accident.date_accid, accident.imat_b, accident.devis_rem, accident.nom_cond, accident.prenom_cond, user.nom, user.prenom, accident.id_accident
        FROM user
             ...
             $.ajax({
                type:"post",
                 ...
                 success:function(reponse){
                     ...
                     if(reponse=="ok"){
                         alert('Devis est modifié');
                         window.location = 'gerer-devis.php';
                     } else {
                         alert('Entrer un devis');
                     }
